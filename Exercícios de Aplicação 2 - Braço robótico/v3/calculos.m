...
disp('Carregando características do robô')
...
%% Configurações da solução numérica e plot

disp('Carregando configurações do método de newton e dos plots.')

% Método numérico
global precision iMax NPassos
precision = 10^-6               % 1 um (micrômetro)
NPassos = 10                    % Número de passos da trajetória
iMax = 100                      % Número máximo de iterações por ponto
chutePosicao0 = [30 -50 -90]'   % Chute da configuração do robô para a primeira posição
                 % em graus
